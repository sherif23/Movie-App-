...
public class FetchReviewTask extends AsyncTask <Movie , Void , Void> {
    ...
    protected Void doInBackground(Movie... movies) {
        ...
        try {
            ...
            URL url = new URL("http://api.themoviedb.org/3/movie/" + movies[0].getId() + "/reviews?api_key=b645d8907aee53afe121c18189f87a7f");
        ...
        try {
            movies[0].setReviwesJsonData(forecastJsonStr);
    ...
    public void parseData (Movie movie , String data) throws JSONException {
        ...
        for ( int i = 0 ; i < results.length() ; i++ ) {
             ...
             content.add(result.getString("author") + " : " + result.getString("content")) ;
        }

        movie.setReview(content);
    }
